...
public class vue_CompteEpargne extends JPanel {
	private JTextField textField;

	/**
	 * Create the panel.
	 */
	public vue_CompteEpargne(final Acceuil a1,final int ID) {
		...
		btnDeconnexion.setBounds(430, 11, 133, 23);
		add(btnDeconnexion);
		...
		double solde = Modele.get_solde_compte_epargne(ID);
