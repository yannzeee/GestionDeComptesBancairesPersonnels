...
public class vue_CompteCourant extends JPanel {
	private JTextField textField;

	/**
	 * Create the panel.
	 */
	public vue_CompteCourant(final Acceuil a1,final int ID) {
		...
		btnDeconnexion.setBounds(432, 11, 131, 23);
		add(btnDeconnexion);
		...
		double solde = Modele.get_solde_compte_courant(ID);
